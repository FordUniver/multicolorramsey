...
\begin{lemma}[Lemma A.1 in~\cite{Balister2024}]  
...
\begin{lemma}[Moments Lemma (Lemma 3.2 in~\cite{Balister2024})]
  \label{lem:moments}
  \lean{moments}
...
\begin{lemma}[Special-function lemma (Part 1 of Lemma 3.3 in~\cite{Balister2024})]
...
\begin{lemma}[Special-function lemma (Part 2 of Lemma 3.3 in~\cite{Balister2024})]
...
\begin{lemma}[Geometric lemma (Lemma 3.1 in~\cite{Balister2024})]
  \label{lem:geometric}
...
\begin{lemma}[Key lemma (Lemma 2.2 in~\cite{Balister2024})]
  \label{lem:key-lemma}
  \uses{def:p}
...
\begin{algorithm}[The Multicolour Book Algorithm in~\cite{Balister2024}]\label{alg:book}
...
\begin{lemma}[Lemma 4.1 in~\cite{Balister2024}]\label{lem:pi:lower:bound}
  \uses{alg:book}
...
\begin{lemma}[Lemma 4.2 in~\cite{Balister2024}]\label{lem:pi:min} 
  \uses{alg:book}
  If\/ $t \ge 2$, then 
...
\begin{lemma}[Lemma 4.3 in~\cite{Balister2024}]\label{lem:Bi:max}
  \uses{alg:book}
...
\begin{lemma}[Lemma 4.4 in~\cite{Balister2024}]\label{lem:Y:lower:bound}
  \uses{alg:book}
  If\/ $t \ge 2$, then
...
\begin{lemma}[Lemma 4.5 in~\cite{Balister2024}]\label{lem:X:lower:bound}
  \uses{alg:book}
  For each $s \in \N$, 
...
\begin{lemma}[Lemma 4.6 in~\cite{Balister2024}]\label{lem:sum:of:lambdas}
  \uses{alg:book}
...
\begin{lemma}[Lemma 5.2 in~\cite{Balister2024}]\label{lem:ESz:steps}
...
\begin{lemma}[Lemma 5.3 in~\cite{Balister2024}]\label{lem:many:ESz:steps}
...
\begin{theorem}[Theorem 5.1 in~\cite{Balister2024}] \label{thm:Ramsey:multicolour:quant}
...
\begin{proof}
  \uses{lem:ESz:steps, lem:many:ESz:steps, thm:book}
