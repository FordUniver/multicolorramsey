...
\begin{proof}
  ...
  \end{align}
  Taking the expected value of both sides of the previous equation and applying Tonelli's theorem gives:
  \begin{align*}
    ...
    & \le \, \beta (cr + 1),
  \end{align*}
 where in the second step we used $\Pr(E) \le \beta$ and $c \le C - 1$, and in the final step we used the fact that $\int_0^\infty \frac{1}{2\sqrt{x}} e^{-\sqrt{x}} \, \mathrm{d}x = 1$.
