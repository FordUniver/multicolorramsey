...
\begin{lemma}[Geometric lemma]
  ...
  \paperref{Lemma 3.1}
  \uses{lem:expPos, lem:special:function:1, lem:special:function:2, lem:integral-exp-decay}
  \lean{geometric}
  %
...
\begin{proof}
  \uses{def:p, lem:expPos, lem:special:function:1, lem:special:function:2}
  ...
  By \autoref{lem:expPos}, we have
  \begin{equation}\label{eq:Ex:f:positive:ref}
    \Ex\big[ f\big( Z_1,\ldots,Z_r \big) \big] \ge 0.
  \end{equation}
