...
%
\begin{proof}
  This follows from \autoref{lem:moments} and linearity of expectation, since all of the coefficients of the Taylor expansion of \(f\) are non-negative (\autoref{lem:taylor-nonneg}).
\end{proof}
