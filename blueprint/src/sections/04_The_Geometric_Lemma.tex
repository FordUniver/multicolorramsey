...
% [DEFINITION] Definition of cosh√x via Taylor series
% Source: blueprint/paper/sections/section_the_proof_of_the_key_lemma.tex line 39-40 (implicit)
% Deprecated blueprint: deprecated/02_Preliminaries.tex line 47-52 (\begin{definition}\label{def:coshsqrt})
% Lean status: ✓ Implemented as `coshsqrt` in Basic.lean
% Label: def:coshsqrt
% TODO: Add Taylor series definition cosh√x = ∑_{n=0}^∞ x^n/(2n)!
...
% [LEMMA] Non-negative Taylor coefficients of special function
...
% Lean status: ✓ Used implicitly in moments proof in Basic.lean
% Label: lem:taylor-nonneg
% TODO: Add proof that all coefficients of f's Taylor expansion are non-negative
