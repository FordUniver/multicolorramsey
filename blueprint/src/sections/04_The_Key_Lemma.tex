...
This corresponds to the \texttt{le\_dotProduct\_iff\_le\_card\_inter} statement in the Lean code.
...
We can deduce \autoref{lem:key-lemma} from \autoref{lem:geometric}.
...
\begin{proof}
  ...
  % Lean: defines N', proves N'sub, N'subN, N'card, defines σ
  % ========================================================================
  %
  ...
  \begin{remark}
    ...
    In Lean, this is proven formally via \texttt{p'} and \texttt{exists\_subset\_card\_eq}.
  \end{remark}
  %
  ...
  % Lean: setup measure space, call geometric, destructure
  % ========================================================================
  ...
  % Lean: defines Y', proves Y'card, proves Y'lee with factor function
  % ========================================================================
  ...
  \begin{remark}[Lean structure]
    In the Lean proof, both cases are handled simultaneously using a \texttt{factor} function defined as \(\text{factor}(i) = \lambda\) if \(i = \ell\) and \(-1\) otherwise.
